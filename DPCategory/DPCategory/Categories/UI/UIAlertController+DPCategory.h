//
//  UIAlertController+DPCategory.h
//  DPCategory
//
...
typedef void (^ dpAlertTapBlock)(NSInteger index, UIAlertAction *action);
@interface UIAlertController (DPCategory)
 ...
 */
@property (nonatomic, copy, readonly) UIAlertController * (^ actionTap) (dpAlertTapBlock tapIndex);
