...
#define DPSTRINGHASH(method)\
return [[self utf8Data] method];

#define DPSTRINGHASH_KEY(method,key)\
return [[self utf8Data] hmac##method##StringWithKey:key];

@implementation NSString (Hash)
- (NSString *)md2String{
    DPSTRINGHASH(md2String)
}

- (NSString *)md4String{
    DPSTRINGHASH(md4String)
}

- (NSString *)md5String{
    DPSTRINGHASH(md5String)
}

- (NSString *)sha1String{
    DPSTRINGHASH(sha1String)
}

- (NSString *)sha224String{
    DPSTRINGHASH(sha224String)
}

- (NSString *)sha256String{
    DPSTRINGHASH(sha256String)
}

- (NSString *)sha384String{
    DPSTRINGHASH(sha384String)
}
...
- (NSString *)hmacMD5StringWithKey:(NSString *)key{
    DPSTRINGHASH_KEY(MD5,key)
}

- (NSString *)hmacSHA1StringWithKey:(NSString *)key{
    DPSTRINGHASH_KEY(SHA1,key)
}

- (NSString *)hmacSHA224StringWithKey:(NSString *)key{
    DPSTRINGHASH_KEY(SHA224,key)
}

- (NSString *)hmacSHA256StringWithKey:(NSString *)key{
    DPSTRINGHASH_KEY(SHA256,key)
}

- (NSString *)hmacSHA384StringWithKey:(NSString *)key{
    DPSTRINGHASH_KEY(SHA384,key)
}

- (NSString *)hmacSHA512StringWithKey:(NSString *)key{
    DPSTRINGHASH_KEY(SHA512,key)
}
@end
...
- (NSString *)deleteEmoji{
    __block NSMutableString *mutableStr = [NSMutableString stringWithCapacity:self.length];
    [self enumerateSubstringsInRange:NSMakeRange(0, self.length) options:NSStringEnumerationByComposedCharacterSequences usingBlock:^(NSString * _Nullable substring, NSRange substringRange, NSRange enclosingRange, BOOL * _Nonnull stop) {
        [mutableStr appendString:([substring isContainEmoji])? @"" : substring];
    }];
    return mutableStr;
}
@end
