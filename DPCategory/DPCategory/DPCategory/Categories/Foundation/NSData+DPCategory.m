...
@end
#define DPDATA_ENCRYTION(encryptionType, clas)\
\
...
#define DPDATA_WITH_KEY(alg, key)\
\
...
- (NSData *)md2Data{
    ...
    DPDATA_ENCRYTION(MD2, 0)
    
}

- (NSString *)md2String{
    DPDATA_ENCRYTION(MD2, 1)
}
- (NSString *)md4String{
    DPDATA_ENCRYTION(MD4, 1)
}

- (NSData *)md4Data{
    DPDATA_ENCRYTION(MD4, 0)
}

- (NSString *)md5String{
    DPDATA_ENCRYTION(MD5, 1)
}

- (NSData *)md5Data{
    DPDATA_ENCRYTION(MD5, 0)
}

- (NSString *)sha1String{
    DPDATA_ENCRYTION(SHA1, 1)
}

- (NSData *)sha1Data{
    DPDATA_ENCRYTION(SHA1, 0)
}

- (NSString *)sha224String{
    DPDATA_ENCRYTION(SHA224, 1)
}

- (NSData *)sha224Data{
    DPDATA_ENCRYTION(SHA224, 0);
}

- (NSString *)sha256String{
    DPDATA_ENCRYTION(SHA256, 1);
}

- (NSData *)sha256Data{
    DPDATA_ENCRYTION(SHA256, 0);
}

- (NSString *)sha384String{
    DPDATA_ENCRYTION(SHA384, 1);
}

- (NSData *)sha384Data{
    DPDATA_ENCRYTION(SHA384, 0);
}

- (NSString *)sha512String{
    DPDATA_ENCRYTION(SHA512, 1);
}

- (NSData *)sha512Data{
    DPDATA_ENCRYTION(SHA512, 0);
}


- (NSString *)hmacMD5StringWithKey:(NSString *)key{
    DPDATA_WITH_KEY(MD5, key)
}
