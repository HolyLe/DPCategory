...
#import <sys/sysctl.h>
#import <mach/mach.h>
#import "UIDevice+DPCategory.h"
#import <pthread.h>
#import <objc/runtime.h>
#ifndef DPSYNTH_DYNAMIC_PROPERTY_OBJECT
#define DPSYNTH_DYNAMIC_PROPERTY_OBJECT(_getter_, _setter_, _association_, _type_) \
...
@interface _DPUIApplicationNetworkIndicatorInfo : NSObject
@property (nonatomic, assign) NSInteger count;
@property (nonatomic, strong) NSTimer *timer;
@end

@implementation _DPUIApplicationNetworkIndicatorInfo
@end
...
- (BOOL)isPirated {
    ...
    if (![self _DP_fileExistInMainBundle:@"_CodeSignature"]) {
        return YES;
    }
...
- (BOOL)_DP_fileExistInMainBundle:(NSString *)name {
...
DPSYNTH_DYNAMIC_PROPERTY_OBJECT(networkActivityInfo, setNetworkActivityInfo, RETAIN_NONATOMIC, _DPUIApplicationNetworkIndicatorInfo *);
...
- (void)_changeNetworkActivityCount:(NSInteger)delta {
    @synchronized(self){
        dispatch_async_on_main_queue(^{
            _DPUIApplicationNetworkIndicatorInfo *info = [self networkActivityInfo];
            if (!info) {
                info = [_DPUIApplicationNetworkIndicatorInfo new];
